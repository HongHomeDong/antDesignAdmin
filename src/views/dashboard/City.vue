<template>
  <div class="pageIndex">
    ...
    >
      ...
      >
        <a-form-model-item label="人员" prop="person">
          <a-input
...
<script>
  ...
  const columns = [
    { title: '人员', dataIndex: 'person', key: 'person', width: 500 },
    { title: '地区', dataIndex: 'city', key: 'city', width: 500 },
    {
      title: '删除',
      width: 70,
      key: 'delete',
  ...
  export default {
    ...
    data () {
      return {
        ...
        rules: {
          person: [
            { required: true, trigger: 'blur', message: '人员不能为空' }
          ]
        }
      }
    },
    ...
    methods: {
      ...
      rowDelete (e, value) {
        this.$confirm({
          ...
          content: '确定删除该条数据？',
          onOk: () => {
            return deletePersonCity({ id: e.id })
              .then(res => {
                this.getCardDetailApi()
              })
          },
